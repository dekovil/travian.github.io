...
<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
	...
	<tbody>
		<tr>
			...
			<a href="mailto:<?php echo (defined('PAYPAL_EMAIL') ? PAYPAL_EMAIL : 'sk@martinambrus.com') ?>">payment account</a>. <br /><br /><b>Username<br />Payment Method<br />Ordered Package<br />
